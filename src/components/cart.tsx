  ...
  return (
    <>
      <Dialog>
        ...
        <DialogContent className='bg-[#f2f2f2] max-w-[100vw] max-h-[80vh] overflow-y-auto md:max-w-[70%] md:max-h-[90vh] p-0 md:top-[50%] top-[60%] w-full lg:w-3/4'>
          <DialogHeader className='flex justify-center items-center mt-4'>
            <DialogTitle className='text-base lg:text-xl uppercase'>
              Giỏ Hàng
            </DialogTitle>
          </DialogHeader>
          {cartItems.length === 0 && (
          ...
          {cartItems.length > 0 && (
            <div className='px-4'>
              {cartItems.map((item, index) => {
                ...
                return (
                  <div key={item.id} className='md:flex mb-4'>
                    ...
                    <div
                      ...
                      <p className='uppercase flex md:block justify-between font-semibold mr-4 mb-2'>
                        <span> SIZE: </span>
                        <span>
                      ...
                      <p className='uppercase justify-between lg:justify-start font-semibold mr-4 flex items-center gap-2 mb-2'>
                        <span> SỐ LƯỢNG:</span>
              ...
              <div className='sticky bottom-0 bg-[#f2f2f2] border-t border-[#736345] py-4 z-10  mt-4 pt-4'>
